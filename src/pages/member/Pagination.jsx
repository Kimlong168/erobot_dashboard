...
const Pagination = ({ notifyDeleting, members, numberOfRecordsPerPage }) => {
  ...
  const { records, pageNumbers, setActivePage, setRecordsPerPage } =
    usePagination({
      activePage: 1,
      recordsPerPage: 5,
      totalRecordsLength: members.length,
      offset: 2,
          ...
          return (
            ...
            >
              ...
              <td className="px-4 py-3">
                ...
                {showImage.open && showImage.image == item.profilePicture && (
                  <PopupImage
                    image={item.profilePicture}
              ...
              <td className="px-4 py-3 text-sm text-center cursor-pointer">
                <div
                  onClick={() => notifyDeleting(item.id, item.memberImageId)}
